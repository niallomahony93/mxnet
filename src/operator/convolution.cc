...
.add_argument("data", "Symbol", "Input data to the ConvolutionOp."
              " Shape: (batchsize, input channels, height, width).")
.add_argument("weight", "Symbol", "Weight matrix."
              " Shape: (num filters, input channels, filter height, filter width).")
.add_argument("bias", "Symbol", "Bias parameter. Shape: (num filters,).")
