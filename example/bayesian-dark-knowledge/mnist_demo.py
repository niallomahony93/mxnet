...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="MNIST classification example in the paper [NIPS2015]Bayesian Dark Knowledge")
    group = parser.add_mutually_exclusive_group()
    group.add_argument("-d", "--dataset", type=int,
                       help="Type of algorithm to use. 0 --> TOY, 1 --> MNIST")
    parser.add_argument("-l", "--algorithm", type=int,
