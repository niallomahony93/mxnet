...
class AtariGame(object):
    ...
    def begin_episode(self, max_episode_step=DEFAULT_MAX_EPISODE_STEP):
        ...
        if self.current_episode_step > self.max_episode_step or self.ale.game_over():
            self.start()
    ...
    def episode_terminate(self):
        termination_flag = self.ale.game_over() or self.current_episode_step > self.max_episode_step
